...
## Enhancements
- Add a Microsoft Works 7/8 WPS writer with text, basic styles, tables, inline images, and deterministic validation by [@Furox-Art](https://github.com/Furox-Art) fixing [#69](https://github.com/PHPOffice/PHPWord/issues/69)
